...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( File image)?  success,TResult Function( String errorMessage)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.image);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( File image)  success,required TResult Function( String errorMessage)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.image);case Failure():
return failure(_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( File image)?  success,TResult? Function( String errorMessage)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class _Initial implements ImageState {
  const _Initial();
...
class Loading implements ImageState {
  const Loading();
...
class Success implements ImageState {
  const Success(this.image);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.image, image) || other.image == image));
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ImageStateCopyWith<$Res> {
...
class Failure implements ImageState {
...
@override
String toString() {
  return 'ImageState.failure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $ImageStateCopyWith<$Res> {
